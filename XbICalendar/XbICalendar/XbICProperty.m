...
/**
 * Show the literal form of the property kind
 *
 * @author fb
 * @version fb:bb#2
 */
- (NSString *)stringWithICalPropertyKind
{
    NSDictionary *dict = @{
                           @(0):@"ICAL_ANY_PROPERTY",
                           @(102):@"ICAL_ACCEPTRESPONSE_PROPERTY",
                           @(1):@"ICAL_ACKNOWLEDGED_PROPERTY",
                           @(2):@"ICAL_ACTION_PROPERTY",
                           @(3):@"ALLOWCONFLICT_PROPERTY",
                           @(4):@"ATTACH_PROPERTY",
                           @(5):@"ATTENDEE_PROPERTY",
                           @(101):@"BUSYTYPE_PROPERTY",
                           @(6):@"CALID_PROPERTY",
                           @(7):@"CALMASTER_PROPERTY",
                           @(8):@"CALSCALE_PROPERTY",
                           @(9):@"CAPVERSION_PROPERTY",
                           @(10):@"CARLEVEL_PROPERTY",
                           @(11):@"CARID_PROPERTY",
                           @(12):@"CATEGORIES_PROPERTY",
                           @(13):@"CLASS_PROPERTY",
                           @(14):@"CMD_PROPERTY",
                           @(15):@"COMMENT_PROPERTY",
                           @(16):@"COMPLETED_PROPERTY",
                           @(17):@"COMPONENTS_PROPERTY",
                           @(18):@"CONTACT_PROPERTY",
                           @(19):@"CREATED_PROPERTY",
                           @(20):@"CSID_PROPERTY",
                           @(21):@"DATEMAX_PROPERTY",
                           @(22):@"DATEMIN_PROPERTY",
                           @(23):@"DECREED_PROPERTY",
                           @(24):@"DEFAULTCHARSET_PROPERTY",
                           @(25):@"DEFAULTLOCALE_PROPERTY",
                           @(26):@"DEFAULTTZID_PROPERTY",
                           @(27):@"DEFAULTVCARS_PROPERTY",
                           @(28):@"DENY_PROPERTY",
                           @(29):@"DESCRIPTION_PROPERTY",
                           @(30):@"DTEND_PROPERTY",
                           @(31):@"DTSTAMP_PROPERTY",
                           @(32):@"DTSTART_PROPERTY",
                           @(33):@"DUE_PROPERTY",
                           @(34):@"DURATION_PROPERTY",
                           @(113):@"ESTIMATEDDURATION_PROPERTY",
                           @(35):@"EXDATE_PROPERTY",
                           @(36):@"EXPAND_PROPERTY",
                           @(37):@"EXRULE_PROPERTY",
                           @(38):@"FREEBUSY_PROPERTY",
                           @(39):@"GEO_PROPERTY",
                           @(40):@"GRANT_PROPERTY",
                           @(41):@"ITIPVERSION_PROPERTY",
                           @(42):@"LASTMODIFIED_PROPERTY",
                           @(43):@"LOCATION_PROPERTY",
                           @(44):@"MAXCOMPONENTSIZE_PROPERTY",
                           @(45):@"MAXDATE_PROPERTY",
                           @(46):@"MAXRESULTS_PROPERTY",
                           @(47):@"MAXRESULTSSIZE_PROPERTY",
                           @(48):@"METHOD_PROPERTY",
                           @(49):@"MINDATE_PROPERTY",
                           @(50):@"MULTIPART_PROPERTY",
                           @(51):@"NAME_PROPERTY",
                           @(52):@"ORGANIZER_PROPERTY",
                           @(53):@"OWNER_PROPERTY",
                           @(54):@"PERCENTCOMPLETE_PROPERTY",
                           @(55):@"PERMISSION_PROPERTY",
                           @(110):@"POLLCOMPLETION_PROPERTY",
                           @(103):@"POLLITEMID_PROPERTY",
                           @(104):@"POLLMODE_PROPERTY",
                           @(105):@"POLLPROPERTIES_PROPERTY",
                           @(106):@"POLLWINNER_PROPERTY",
                           @(56):@"PRIORITY_PROPERTY",
                           @(57):@"PRODID_PROPERTY",
                           @(58):@"QUERY_PROPERTY",
                           @(59):@"QUERYLEVEL_PROPERTY",
                           @(60):@"QUERYID_PROPERTY",
                           @(61):@"QUERYNAME_PROPERTY",
                           @(62):@"RDATE_PROPERTY",
                           @(63):@"RECURACCEPTED_PROPERTY",
                           @(64):@"RECUREXPAND_PROPERTY",
                           @(65):@"RECURLIMIT_PROPERTY",
                           @(66):@"RECURRENCEID_PROPERTY",
                           @(67):@"RELATEDTO_PROPERTY",
                           @(68):@"RELCALID_PROPERTY",
                           @(69):@"REPEAT_PROPERTY",
                           @(111):@"REPLYURL_PROPERTY",
                           @(70):@"REQUESTSTATUS_PROPERTY",
                           @(71):@"RESOURCES_PROPERTY",
                           @(112):@"RESPONSE_PROPERTY",
                           @(72):@"RESTRICTION_PROPERTY",
                           @(73):@"RRULE_PROPERTY",
                           @(74):@"SCOPE_PROPERTY",
                           @(75):@"SEQUENCE_PROPERTY",
                           @(76):@"STATUS_PROPERTY",
                           @(77):@"STORESEXPANDED_PROPERTY",
                           @(78):@"SUMMARY_PROPERTY",
                           @(79):@"TARGET_PROPERTY",
                           @(114):@"TASKMODE_PROPERTY",
                           @(80):@"TRANSP_PROPERTY",
                           @(81):@"TRIGGER_PROPERTY",
                           @(82):@"TZID_PROPERTY",
                           @(108):@"TZIDALIASOF_PROPERTY",
                           @(83):@"TZNAME_PROPERTY",
                           @(84):@"TZOFFSETFROM_PROPERTY",
                           @(85):@"TZOFFSETTO_PROPERTY",
                           @(109):@"TZUNTIL_PROPERTY",
                           @(86):@"TZURL_PROPERTY",
                           @(87):@"UID_PROPERTY",
                           @(88):@"URL_PROPERTY",
                           @(89):@"VERSION_PROPERTY",
                           @(107):@"VOTER_PROPERTY",
                           @(90):@"X_PROPERTY",
                           @(91):@"XLICCLASS_PROPERTY",
                           @(92):@"XLICCLUSTERCOUNT_PROPERTY",
                           @(93):@"XLICERROR_PROPERTY",
                           @(94):@"XLICMIMECHARSET_PROPERTY",
                           @(95):@"XLICMIMECID_PROPERTY",
                           @(96):@"XLICMIMECONTENTTYPE_PROPERTY",
                           @(97):@"XLICMIMEENCODING_PROPERTY",
                           @(98):@"XLICMIMEFILENAME_PROPERTY",
                           @(99):@"XLICMIMEOPTINFO_PROPERTY",
                           @(100):@"NO_PROPERTY"
                           };
    return (NSString *)[dict objectForKey:@(self.kind)];
}
